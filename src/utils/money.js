  ...
  static orderPrice = (
    ...
    /* const calcBOGOFPrice = (tempBuyOneGetOneFreePromotion) => {
            ...
            if (tempBuyOneGetOneFreePromotion.orderItems?.length >= 2) {
                if (eligibleItemsGroup1Percent === 0 && eligibleItemsGroup2Percent === 0) {
                    if (tempBuyOneGetOneFreePromotion.orderItems[0].priceSum <= tempBuyOneGetOneFreePromotion.orderItems[1].priceSum) {
                        tempBuyOneGetOneFreePromotion.orderItems[0].discountAmt = tempBuyOneGetOneFreePromotion.orderItems[0].priceSum;
                        tempBuyOneGetOneFreePromotion.orderItems[0].priceSum = 0;
                        // currentPromotion.orderItems[0].price = 0;
                        tempBuyOneGetOneFreePromotion.orderItems[0].discountName = tempBuyOneGetOneFreePromotion.name;
                        ...
                        tempBuyOneGetOneFreePromotion.orderItems[1].discountAmt = tempBuyOneGetOneFreePromotion.orderItems[1].priceSum;
                        tempBuyOneGetOneFreePromotion.orderItems[1].priceSum = 0;
                        tempBuyOneGetOneFreePromotion.orderItems[1].discountName = tempBuyOneGetOneFreePromotion.name;
                    ...
                    if (tempBuyOneGetOneFreePromotion.orderItems[0].priceSum <= tempBuyOneGetOneFreePromotion.orderItems[1].priceSum) {
                        discountAmount1 = tempBuyOneGetOneFreePromotion.orderItems[0].priceSum * eligibleItemsGroup1Percent / 100;
                        discountAmount2 = tempBuyOneGetOneFreePromotion.orderItems[1].priceSum * eligibleItemsGroup2Percent / 100;
                        tempBuyOneGetOneFreePromotion.orderItems[0].priceSum = tempBuyOneGetOneFreePromotion.orderItems[0].priceSum - discountAmount1;
                        // currentPromotion.orderItems[0].price = currentPromotion.orderItems[0].price * (100 - eligibleItemsGroup1Percent) / 100;
                        tempBuyOneGetOneFreePromotion.orderItems[0].discountName = tempBuyOneGetOneFreePromotion.name;
                        tempBuyOneGetOneFreePromotion.orderItems[0].discountAmt = discountAmount1;
                        tempBuyOneGetOneFreePromotion.orderItems[0].discountPercentage = eligibleItemsGroup1Percent;
                        // orderingItem.price = orderingItem.priceSum * (100 - eligibleItemsGroup2Percent) / 100;
                        tempBuyOneGetOneFreePromotion.orderItems[1].priceSum = tempBuyOneGetOneFreePromotion.orderItems[1].priceSum - discountAmount2;
                        tempBuyOneGetOneFreePromotion.orderItems[1].discountName = tempBuyOneGetOneFreePromotion.name;
                        tempBuyOneGetOneFreePromotion.orderItems[1].discountAmt = discountAmount2;
                        tempBuyOneGetOneFreePromotion.orderItems[1].discountPercentage = eligibleItemsGroup2Percent;
                        return discountAmount1 + discountAmount2;
                    } else {
                        discountAmount1 = tempBuyOneGetOneFreePromotion.orderItems[0].priceSum * eligibleItemsGroup2Percent / 100;
                        discountAmount2 = tempBuyOneGetOneFreePromotion.orderItems[1].priceSum * eligibleItemsGroup1Percent / 100;
                        tempBuyOneGetOneFreePromotion.orderItems[0].priceSum = tempBuyOneGetOneFreePromotion.orderItems[0].priceSum - discountAmount1;
                        // currentPromotion.orderItems[0].price = currentPromotion.orderItems[0].price * (100 - eligibleItemsGroup2Percent) / 100;
                        tempBuyOneGetOneFreePromotion.orderItems[0].discountName = tempBuyOneGetOneFreePromotion.name;
                        tempBuyOneGetOneFreePromotion.orderItems[0].discountAmt = discountAmount1;
                        tempBuyOneGetOneFreePromotion.orderItems[0].discountPercentage = eligibleItemsGroup2Percent;
                        // orderingItem.price = orderingItem.priceSum * (100 - eligibleItemsGroup1Percent) / 100;
                        tempBuyOneGetOneFreePromotion.orderItems[1].priceSum = tempBuyOneGetOneFreePromotion.orderItems[1].priceSum - discountAmount2;
                        tempBuyOneGetOneFreePromotion.orderItems[1].discountName = tempBuyOneGetOneFreePromotion.name;
                        tempBuyOneGetOneFreePromotion.orderItems[1].discountAmt = discountAmount2;
                        tempBuyOneGetOneFreePromotion.orderItems[1].discountPercentage = eligibleItemsGroup1Percent;
                        return discountAmount1 + discountAmount2;
                    }
                }
            }
        ...
        if (currentOrderItems.length > 0 && activePromotions && activePromotions.length > 0) {
            ...
            activePromotions.filter(promo => promo.type === 'S').map(promo => {
                const {orderTimeOption} = promo;
                let totalDiscountMoneyForEachDiscountOnItemPromo = Money.__instance.currency(0);
                let selectedPaymentMethodArr;
                let selectedOrderingMethodArr;
                selectedPaymentMethodArr = promo?.selectedPaymentMethod?.split(',')?.filter(Boolean) || [];
                selectedOrderingMethodArr = promo?.orderingMethod?.split(',')?.filter(Boolean) || [];
                if (removedPromotions?.length <= 0 || !removedPromotions?.includes(promo.id)) {
                    let matchItemId = false;
                    let matchItemModId = false;
                    let hasAtleastOneMatch = false;
                    if (promo.clientType === 'A' || (promo.clientType !== 'A' && promo.clientType === currentClientType)) {
                        currentOrderItems = currentOrderItems.map(orderItem => {
                            let eligibleItems = promo.eligibleItemsId ? JSON.parse(promo.eligibleItemsId) : [];
                                ...
                                eCat.items.filter(eItem => {
                                    if (eItem.id === orderItem.itemId) {
                                        ...
                                        eItem.modifierGroupItems.filter(eGroupModItem => {
                                            eGroupModItem.modifierGroup.modifiers = eGroupModItem.modifierGroup.modifiers.filter(emod => {
                            ...
                            if (matchItemId && matchItemModId && (selectedPaymentMethodArr.length === 0 || selectedPaymentMethodArr.includes(userSelectedPaymentMethod))
                                && (selectedOrderingMethodArr.length === 0 || selectedOrderingMethodArr.includes(order?.orderingMethod))
                                && (orderTimeOption === 'A' || (orderTimeOption === 'N' && order?.isPreOrder === false) || (orderTimeOption === 'P' && order?.isPreOrder === true))) {
                                orderItemPriceSumMoney = Money.__instance.currency(orderItemPriceSumValue);
                                discountEligibleItemMoney = orderItemPriceSumMoney.multiply(promo.eligibleItemsGroup1Percent).divide(100);
                                totalDiscountMoneyForEachDiscountOnItemPromo = totalDiscountMoneyForEachDiscountOnItemPromo.add(discountEligibleItemMoney);
                                totalDiscountMoney = totalDiscountMoney.add(totalDiscountMoneyForEachDiscountOnItemPromo);
                                orderItem.priceSum = orderItemPriceSumMoney.subtract(discountEligibleItemMoney).subtract(orderItem.discountAmt).value;
                                orderItem.discountPercentage = (orderItem.discountPercentage || 0) + promo.eligibleItemsGroup1Percent;
                                orderItem.discountName = `Discount on Item (${orderItem.discountPercentage}%)`;
                                orderItem.ooDiscountExplaination = ((orderItem.ooDiscountExplaination || '') == '' ? '' : orderItem.ooDiscountExplaination + '#####') + promo.name + ` (- ${discountEligibleItemMoney.value})`;
    ...
    /* if (currentOrderItems.length > 0 && activePromotions && activePromotions.length > 0) {
            ...
            activePromotions.filter(promo => promo.type === 'G').map(promo => {
                ...
                if (removedPromotions?.length <= 0 || !removedPromotions?.includes(promo.id)) {
                    let hasAtleastOneMatch = false;
                    if (promo.clientType === 'A' || (promo.clientType !== 'A' && promo.clientType === currentClientType)) {
                        currentOrderItems = deepClone(currentOrderItems, []).map(orderItem => {
                            orderItem.discountAmt = orderItem.discountAmt || 0;
                            let orderItemPriceSumValue = 0;
                            let discountEligibleItemMoney = Money.__instance.currency(0);
                            let orderItemPriceSumMoney = Money.__instance.currency(0);
                            ...
                            if (orderItem?.getFreeItemPromoId == promo.id) {
                                if (((subTotal.value - orderItem.priceSum) > promo.minimumOrderAmount) && (selectedPaymentMethodArr.length === 0 || selectedPaymentMethodArr.includes(userSelectedPaymentMethod))
                                    && (selectedOrderingMethodArr.length === 0 || selectedOrderingMethodArr.includes(order?.orderingMethod))
                                    && (orderTimeOption === 'A' || (orderTimeOption === 'N' && order?.isPreOrder === false) || (orderTimeOption === 'P' && order?.isPreOrder === true))) {
                                    orderItemPriceSumValue = Money.calcPrice(orderItem.price, orderItem.qty, orderItem.modifierPriceSum);
                                    orderItemPriceSumMoney = Money.__instance.currency(orderItemPriceSumValue);
                        ...
                        currentOrderItems = currentOrderItems.filter(orderItem => orderItem?.isGetFreeItem !== false);
                        ...
                        if (hasAtleastOneMatch) {
                            ...
                            delete promo.picture;
                            selectedPromotions.push(promo);
                            subTotalValue = currentOrderItems.map(item => item.priceSum).reduce((a, b) => {
                                return Money.sum(a, b);
                            }, 0);
        ...
        let priceSumOfAllOrderItemsInAll_BOGOF_promotions_value = buyOneGetOneFreePromotions.map(promotion => {
            let priceSumOfAllOrderItemsForOne_BOGOF_promotion = promotion.orderItems.map(itm => itm.priceSum).reduce((a, b) => Money.sum(a, b), 0);
        ...
        subTotal = subTotal.add(priceSumOfAllOrderItemsInAll_BOGOF_promotions_value);
        total = total.add(priceSumOfAllOrderItemsInAll_BOGOF_promotions_value);
        let hasAdjustByeOneGetOneFree = false;
        if ((buyOneGetOneFreePromotions.length > 0 || currentOrderItems.length > 0) && activePromotions && activePromotions.length > 0) {
            activePromotions.map(promo => {
                ...
                if (removedPromotions?.length <= 0 || !removedPromotions?.includes(promo.id)) {
                    if (promo.type === 'K') {
                        ...
                        if (currentUser?.access_token && promo.clientType === 'N' && currentClientType === 'N') {
                            if (subTotal > minimumOrderAmount) {
                                globalDiscountPercent = globalDiscountPercent.add(discountPercent);
                    ...
                    } else if (promo.type === 'F' && order.orderingMethod == promo.orderingMethod) {
                        // free delivery fee
                        if (promo.clientType === 'A' || (promo.clientType !== 'A' && promo.clientType === currentClientType)) {
                            ...
                            if (promo?.selectedDeliveryZone?.split(',').includes("" + order?.deliveryZoneId || '') || (promo?.selectedDeliveryZone || []).length == 0) {
                                if (subTotal > minimumOrderAmount && continueCheck) {
                                    deliveryFeeDiscountMoney = originalDeliveryFee.multiply(discountPercent).divide(100);
                        ...
                        if (promo.clientType === 'A' || (promo.clientType !== 'A' && promo.clientType === currentClientType)) {
                            ...
                            if (subTotal > minimumOrderAmount && continueCheck) {
                                if ((selectedPaymentMethodArr.length === 0 || selectedPaymentMethodArr.includes(userSelectedPaymentMethod))
                                    && (selectedOrderingMethodArr.length === 0 || selectedOrderingMethodArr.includes(order?.orderingMethod))
                                    && (orderTimeOption === 'A' || (orderTimeOption === 'N' && order?.isPreOrder === false) || (orderTimeOption === 'P' && order?.isPreOrder === true))) {
                                    if (promo?.selectedDeliveryZone?.split(',').includes("" + order?.deliveryZoneId || '') || (promo?.selectedDeliveryZone || []).length == 0) {
                                        ...
                                        if(promo?.fullfillmentTimeOption === 'C') {
                                            let deliveryDateTime = order?.deliveryDateTime ? parse(order.deliveryDateTime, 'dd-MM-yyyy HH:mm:ss', new Date()) : new Date();
                                            let fullfillmentWeekDays = JSON.parse(promo.fullfillmentWeekDays);
                                            let deliveryDay = deliveryDateTime.getDay() + 1;
                                            let deliveryTime = format(deliveryDateTime, "HH:mm");
                                            let displayTimes = fullfillmentWeekDays?.displayTimes || [];
                                            for(let i = 0; i < displayTimes.length; i++) {
                                                ...
                                                if (deliveryTime <= from && deliveryTime <= to) {
                                                    deliveryTime = parseInt(deliveryTime.substr(0, 2), 10) + 24 + deliveryTime.substr(2,3);
                                                }
                                                if (to <= from) {
                                                    to = parseInt(to.substr(0, 2), 10) + 24 + to.substr(2,3);
                                                }
                                                // console.log(displayTimes, deliveryDay, from, to, deliveryTime)
                                                if (displayTimes[i]?.days.includes(deliveryDay + "") && deliveryTime >= from && deliveryTime <= to) {
                                                    applyAfterCheckFulFillment = true;
                                                }
                                            }
                                            let fftDateFrom = promo?.fftDateFrom ? new Date(promo.fftDateFrom) : null;
                                            let fftDateTo = promo?.fftDateTo ? new Date(promo.fftDateTo) : null;
                                            if (!applyAfterCheckFulFillment) {
                                                if (fftDateFrom == null || fftDateTo == null) {
                                                    applyAfterCheckFulFillment = true;
                                                } else {
                                                    let fftDateFromStr = format(fftDateFrom, "yyyy-MM-dd");
                                                    let fftDateToStr = format(fftDateTo, "yyyy-MM-dd");
                                                    let deliveryDateTimeStr = format(deliveryDateTime, "yyyy-MM-dd");
                                                    if (deliveryDateTimeStr >= fftDateFromStr && deliveryDateTimeStr <= fftDateToStr) {
                                                        applyAfterCheckFulFillment = true;
                                                    } else {
                        ...
                        if (promo.clientType === 'A' || (promo.clientType !== 'A' && promo.clientType === currentClientType)) {
                            ...
                            if (subTotal > minimumOrderAmount && continueCheck) {
                                if ((selectedPaymentMethodArr.length === 0 || selectedPaymentMethodArr.includes(userSelectedPaymentMethod))
                                    && (selectedOrderingMethodArr.length === 0 || selectedOrderingMethodArr.includes(order?.orderingMethod))
                                    && (orderTimeOption === 'A' || (orderTimeOption === 'N' && order?.isPreOrder === false) || (orderTimeOption === 'P' && order?.isPreOrder === true))) {
                                    globalDiscountPercent = globalDiscountPercent.add(discountPercent / subTotal.value * 100);
                            ...
                            if (promo.couponCode == order?.couponCode) {
                                ...
                                // do {
                                    ...
                                    currentOrderItems.map(orderItem => {
                                        if (orderItem.sequence > maxSequence) maxSequence = orderItem.sequence
                                    });
                                    currentOrderItems = currentOrderItems.map(orderItem => {
                                        let eligibleItems = promo.eligibleItemsId ? JSON.parse(promo.eligibleItemsId) : [];
                                        let eligiblePairItems = promo.eligibleItemsPairId ? JSON.parse(promo.eligibleItemsPairId) : [];
                                        matchItemId = false;
                                        matchItemModId = false;
                                        ...
                                        if (matchItemId && matchItemModId) {
                                            ...
                                            let tmpBuyOneGetOneFreePromotion = JSON.parse(JSON.stringify(promo));
                                            let length = buyOneGetOneFreePromotions?.length || 0;
                                            tmpBuyOneGetOneFreePromotion.seq = `${promo.id}_${length + 1}`;
                                            tmpBuyOneGetOneFreePromotion.orderItems = [];
                                            tmpBuyOneGetOneFreePromotion.couponCode = promo.couponCode;
                                            if (orderItem.qty <= 1) {
                                                orderItem.discountName = tmpBuyOneGetOneFreePromotion.name;
                                            ...
                                            if (buyOneGetOneFreePromotions?.length > 0) {
                                                let tempBuyOneGetOneFreePromotions = buyOneGetOneFreePromotions.map(buyOneGetOneFreePromotion => {
                                                    if (tmpBuyOneGetOneFreePromotion.seq == buyOneGetOneFreePromotion.seq) {
                                                ...
                                                if (tempBuyOneGetOneFreePromotions.length == 0) {
                                                    ...
                                                    tempBuyOneGetOneFreePromotions = buyOneGetOneFreePromotions.map(buyOneGetOneFreePromotion => {
                                                        if (tmpBuyOneGetOneFreePromotion.id == buyOneGetOneFreePromotion.id &&
                                                            buyOneGetOneFreePromotion.orderItems.length == 1 &&
                                                            (buyOneGetOneFreePromotion.orderItems[0].discountName || '') == '') {
                                                            return buyOneGetOneFreePromotion;
                                                        }
                                                    }).filter(Boolean);
                                                    console.log(tempBuyOneGetOneFreePromotions);
                                                    if (tempBuyOneGetOneFreePromotions.length > 0) {
                                                        tmpBuyOneGetOneFreePromotion = tempBuyOneGetOneFreePromotions[0];
                                                        orderItem.discountName = tmpBuyOneGetOneFreePromotion.name;
                                                        tmpBuyOneGetOneFreePromotion.orderItems.push(orderItem);
                                                        ...
                                                        //     }
                                                        // }
                                                        buyOneGetOneFreePromotions = buyOneGetOneFreePromotions.filter(bogop => {
                                                            return bogop.seq != tmpBuyOneGetOneFreePromotion.seq
                                                        });
                                                    }
                                                    hasAdjustByeOneGetOneFree = true;
                                                    let discountAmt = calcBOGOFPrice(tmpBuyOneGetOneFreePromotion);
                                                    subTotal = subTotal.subtract(discountAmt);
                                                    total = total.subtract(discountAmt);
                                                    buyOneGetOneFreePromotions = [...buyOneGetOneFreePromotions, tmpBuyOneGetOneFreePromotion];
                                                }
                                            } else {
                                                console.log("abc");
                                                hasAdjustByeOneGetOneFree = true;
                                            ...
                                            if (matchItemId && matchItemModId) {
                                                ...
                                                let tmpBuyOneGetOneFreePromotionPair = JSON.parse(JSON.stringify(promo));
                                                if (buyOneGetOneFreePromotions?.length > 0) {
                                                    let tmpBuyOneGetOneFreePromotionPairs = buyOneGetOneFreePromotions.map(buyOneGetOneFreePromotion => {
                                                        if (promo.id == buyOneGetOneFreePromotion.id && buyOneGetOneFreePromotion.orderItems.length < 2) {
                                                            if ((buyOneGetOneFreePromotion.orderItems[0].discountName || '') != '')
                                                                return buyOneGetOneFreePromotion;
                                                            else
                                                                return null;
                                                        }
                                                    ...
                                                    if (tmpBuyOneGetOneFreePromotionPairs?.length > 0)
                                                        tmpBuyOneGetOneFreePromotionPair = tmpBuyOneGetOneFreePromotionPairs[0]
                                                    else {
                                                        let length = buyOneGetOneFreePromotions?.length || 0;
                                                        tmpBuyOneGetOneFreePromotionPair.seq = `${promo.id}_${length + 1}`;
                                                        tmpBuyOneGetOneFreePromotionPair.orderItems = [];
                                                        tmpBuyOneGetOneFreePromotionPair.couponCode = promo.couponCode;
                                                    }
                                                } else {
                                                    let length = buyOneGetOneFreePromotions?.length || 0;
                                                    tmpBuyOneGetOneFreePromotionPair.seq = `${promo.id}_${length + 1}`;
                                                ...
                                                if (tmpBuyOneGetOneFreePromotionPair.orderItems.length > 0) {
                                                    if (orderItem.qty <= 1) {
                                                        tmpBuyOneGetOneFreePromotionPair.orderItems.push(orderItem);
                                                        ...
                                                        newOrderItem.qty = 1;
                                                        newOrderItem.priceSum = Money.calcPrice(newOrderItem.price, newOrderItem.qty, newOrderItem.modifierPriceSum);
                                                        tmpBuyOneGetOneFreePromotionPair.orderItems.push(newOrderItem);
                                                        matchItemId = false;
                                                        matchItemModId = false;
                                                    }
                                                }
                                                if (tmpBuyOneGetOneFreePromotionPair.orderItems.length > 1) {
                                                    let discountAmt = calcBOGOFPrice(tmpBuyOneGetOneFreePromotionPair);
                                                    subTotal = subTotal.subtract(discountAmt);
                                                    total = total.subtract(discountAmt);
                                                    if (buyOneGetOneFreePromotions?.length > 0) {
                                                        const tempBuyOneGetOneFreePromotions = buyOneGetOneFreePromotions.filter(buyOneGetOneFreePromotion => {
                                                            if (tmpBuyOneGetOneFreePromotionPair.seq == buyOneGetOneFreePromotion.seq) {
                                                                return buyOneGetOneFreePromotion;
                                                            }
                                                        });
                                                        console.log(tempBuyOneGetOneFreePromotions);
                                                        if (tempBuyOneGetOneFreePromotions.length == 0) {
                                                            hasAdjustByeOneGetOneFree = true;
                                                            buyOneGetOneFreePromotions = [...buyOneGetOneFreePromotions, tmpBuyOneGetOneFreePromotionPair];
                                                        }
                                                    } else {
                                                        hasAdjustByeOneGetOneFree = true;
                                                        buyOneGetOneFreePromotions = [...buyOneGetOneFreePromotions, tmpBuyOneGetOneFreePromotionPair];
                        ...
                        if (buyOneGetOneFreePromotions?.length > 0) {
                            const tempBuyOneGetOneFreePromotion = buyOneGetOneFreePromotions.filter(buyOneGetOneFreePromotion => {
                                if (promo.id === buyOneGetOneFreePromotion.id) {
                                    if ((promo.displayTime != 'H' || (buyOneGetOneFreePromotion?.couponCode || '') == order.couponCode)) {
                                        return buyOneGetOneFreePromotion;
                                    } else {
                                        ...
                                        currentOrderItems = [...currentOrderItems, ...buyOneGetOneFreePromotion.orderItems];
                                        hasAdjustByeOneGetOneFree = true;
                                    }
                                } else {
                                    return buyOneGetOneFreePromotion;
