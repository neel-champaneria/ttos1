...
export default (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case MODIFY_ITEM_FROM_CART: {
      ...
      console.log(
        "before update: currentOrderingItems: ",
        currentOrderingItems
      );
      console.log("before update: price: ", orderPrice);

      console.log(
        "after update: tempUpdatedCurrentOrderingItems: ",
        tempUpdatedCurrentOrderingItems
      );
      console.log("after after update: price: ", newOrderPrice);
      return {
        ...state,
        ...newOrderPrice,
        checkoutResponse: null,
